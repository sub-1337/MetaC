...
Задание using имён типов, которые не приводятся по умолчанию к исходным.

declval и создание объектов без конструктора по умолчанию.

`static` в шаблоне общий для шаблона.
